...
scope = "user-library-read user-library-modify playlist-read-private user-read-playback-state user-read-currently-playing user-read-recently-played user-top-read"
